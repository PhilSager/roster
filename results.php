...
<html>
<head>
<title>1812 War Roster Search Results</title>
...
<div style="text-align:center;padding:20px;">
	<a class="navlinks" href="index.php">1812 War Roster Search</a>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div style="text-align:center;padding:6px; height: 30px;margin-top:10px;">
   	<?php echo $pages->display_pages(); ?>
    <br/>&nbsp;<br/><a href="index.php">1812 War Roster Searchwill Home</a><br/>
</div> 
